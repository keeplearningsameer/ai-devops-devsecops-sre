...
def main():
    print("Improved Incident Knowledge Retrieval")
    print("=" * 60)
...
""",
    ...
    query = """
The payments-api Kubernetes pods started CrashLoopBackOff immediately
after a new deployment. Application logs show connection refused to
database at db:5432. What information is most relevant for investigating
this incident?
"""
    ...
    print("\nExpected Learning:")
    print(
        "The deployment-related database configuration document "
        "should rank highly because the incident contains both "
        "'after deployment' and 'database connection refused' signals."
    )
